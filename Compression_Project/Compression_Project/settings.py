"""
Django settings for Compression_Project project.
...
SECRET_KEY = 'lvzj=_xj16-l3w8%k5=h(psu8rw&2$y^(fga=60nv0ft&w+^4a'
...
ROOT_URLCONF = 'Compression_Project.urls'
...
WSGI_APPLICATION = 'Compression_Project.wsgi.application'
